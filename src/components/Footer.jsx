      ...
      <div className='bg-primary-0 rounded-lg responsivePad 2xl:py-12 lg:py-10 md:py-8 py-6 2xl:space-y-12 lg:space-y-10 md:space-y-8 space-y-6'>
        <div className="flex flex-col lg:flex-row justify-between items-center space-y-4 lg:space-y-0">
          ...
          <div className="flex space-x-4">
            <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="p hover:text-white-0">
              <i className="bi bi-instagram text-xl"></i>
            </a>
            <a href="https://google.com" target="_blank" rel="noopener noreferrer" className="p hover:text-white-0">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-center space-y-2 lg:space-y-0">
          ...
          <a target='_blank' href="https://bytesitedigital.com.au/">
