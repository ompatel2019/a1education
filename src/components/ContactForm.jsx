...
const ContactForm = ({section, sectionName, sectionSubheading}) => {
  ...
  const formSubheading = "Ready to join A1 Education or have questions about HSC Economics tutoring in Sydney? Reach out to us—our friendly team is here to help";
          ...
          <div className="space-y-8">
            {contacts.map((i, k) => (
              <div className="flex space-x-4 items-start p">
                <div className="h5 rounded-sm border-gray-500">
                  {i.icon}
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <p className="font-generalSans-medium">
                    {i.contactDesc}
                  </p>

                  <a target='_blank' href={i.contactRedirect}>
